...
class editarPlatillo extends StatefulWidget {
  ...
  editarPlatillo({Key ? key, required this.id_cookbook, required this.id_platillo}):super(key:key);

  @override
  _editarPlatilloState createState() => _editarPlatilloState();
}
...
class _editarPlatilloState extends State<editarPlatillo> {
  ...
  Widget build(BuildContext context) {
    ...
    final editPlatilloButton = Material(
      elevation: 5,
  ...
  crearColeccionPlatillo() async{
    ...
    Fluttertoast.showToast(msg: "Platillo editado correctamente!!");
